...
public record IISExpressProjectConfiguration
{
    ...
    /// <summary>
    /// Gets or sets the application URL for the IIS Express project.
    /// </summary>
    /// <remarks>
    /// This is currently internal as wiring it up differently than the default is not yet supported.
    /// </remarks>
    internal PathString ApplicationPath { get; init; } = "/";

    /// <summary>
    /// Gets or sets the virtual directory path for the IIS Express project.
    /// </summary>
    /// <remarks>
    /// This is currently internal as wiring it up differently than the default is not yet supported.
    /// </remarks>
    internal PathString VirtualDirectoryPath { get; init; } = "/";
}
