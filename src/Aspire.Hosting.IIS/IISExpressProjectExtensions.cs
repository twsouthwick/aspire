...
/// </summary>
public static class IISExpressProjectExtensions
{
    /// <summary>
    ...
    internal static IISExpressProjectConfiguration GetSiteConfiguration(this IResourceBuilder<IISExpressProjectResource> resource)
    {
    ...
    private static IResourceBuilder<IISExpressProjectResource> WithIISConfigurationGenerator(this IResourceBuilder<IISExpressProjectResource> builder)
    {
        builder.ApplicationBuilder.Eventing.Subscribe<BeforeResourceStartedEvent>(builder.Resource, (e, token) =>
        {
            ...
            var siteXml = appHostConfig.Descendants("configuration")
                .Descendants("system.applicationHost")
                .Descendants("sites")
                .FirstOrDefault();

            if (siteXml is null)
            {
                logger.LogError("Could not find system.applicationHost/sites in the default IIS Express configuration.");
